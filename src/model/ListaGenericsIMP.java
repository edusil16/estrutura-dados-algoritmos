...
public class ListaGenericsIMP<T> {

    private T[] elementos;
    private int tamanho; // Atributo da classe para dizer o tamanho do model.

    public ListaGenericsIMP(int capacidade) {
        this.elementos = (T[]) new Object[capacidade];
        this.tamanho = 0;
    }

    // Construtor com a capacidade do Array
    public ListaGenericsIMP(int capacidade, Class<T> tipoClasse) {
    ...
    public int buscarPosicaoElementoNoVetor(T elemento) {
